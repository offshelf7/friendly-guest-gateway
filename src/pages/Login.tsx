...
const Login = () => {
  ...
  const onLoginSubmit = async (values: LoginFormValues) => {
    ...
    try {
      ...
      toast({
        title: t('login.error.title'),
        description: error.message || t('login.error.generic'),
        variant: "destructive",
      });
    } finally {
      setIsLoading(false);
  ...
  const onRegisterSubmit = async (values: RegisterFormValues) => {
    ...
    try {
      ...
      toast({
        title: t('register.error.title'),
        description: error.message || t('register.error.generic'),
        variant: "destructive",
      });
    } finally {
      setIsLoading(false);
    ...
    <div className="min-h-screen w-full">
      <div className="container mx-auto p-4 flex flex-col md:flex-row h-screen items-center">
        ...
        <Card className="w-full md:w-1/2 lg:w-2/5 p-8 bg-gray-50 rounded-lg shadow-none">
          <div className="mb-6">
            <h2 className="text-2xl font-bold mb-2">{t('login.welcome')}</h2>
          </div>
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        ...
                        <FormControl>
                          <Input placeholder={t('login.form.emailPlaceholder')} {...field} />
                        </FormControl>
                        <FormMessage />
                      </FormItem>
                    )}
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        ...
                        <FormControl>
                          <Input type="password" placeholder={t('login.form.passwordPlaceholder')} {...field} />
                        </FormControl>
                        <FormMessage />
                      </FormItem>
                    )}
              ...
              <Form {...registerForm}>
                <form onSubmit={registerForm.handleSubmit(onRegisterSubmit)} className="space-y-4">
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        ...
                        <FormControl>
                          <Input placeholder={t('register.form.namePlaceholder')} {...field} />
                        </FormControl>
                        <FormMessage />
                      </FormItem>
                    )}
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        ...
                        <FormControl>
                          <Input placeholder={t('register.form.emailPlaceholder')} {...field} />
                        </FormControl>
                        <FormMessage />
                      </FormItem>
                    )}
                  ...
                  <Button 
                    ...
                    disabled={isLoading}
                  >
                    {isLoading ? t('register.buttons.creating') : t('register.buttons.create')}
                  </Button>
                </form>
              </Form>
            </TabsContent>
            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              <div className="overflow-hidden rounded-lg">
                <BlurImage 
                  ...
                  alt={t('login.images.room')}
                  className="w-full h-32 object-cover"
                />
              </div>
            </div>
            <div className="mt-4 text-center">
              <h3 className="text-2xl font-bold mb-2">{t('login.promo.title')}</h3>
