...
const translations: Record<string, Record<string, string>> = {
  en: {
    ...
    'admin.sidebar.servicesDashboard': 'Services Dashboard',
    ...
    'admin.sidebar.financeDashboard': 'Finance Dashboard',
    ...
    'admin.sidebar.frontOfficeDashboard': 'Front Office Dashboard',
    'admin.sidebar.frontDesk': 'Front Desk',
    'admin.sidebar.reservations': 'Reservations',
    'admin.sidebar.inventory': 'Inventory',
    'admin.sidebar.inventoryDashboard': 'Inventory Dashboard',
    'admin.sidebar.inventoryItems': 'Inventory Items',
  ...
  fr: {
    ...
    'admin.sidebar.mainDashboard': 'Tableau Principal',
    'admin.sidebar.managerDashboards': 'Tableaux des Gestionnaires',
    'admin.sidebar.generalManager': 'Directeur Général',
    'admin.sidebar.operationsManager': 'Directeur Opérationnel',
    'admin.sidebar.serviceManager': 'Directeur de Service',
    'admin.sidebar.maintenanceManager': 'Directeur de Maintenance',
    'admin.sidebar.marketingManager': 'Directeur Marketing',
    'admin.sidebar.hrManager': 'Directeur RH',
    'admin.sidebar.departmentDashboards': 'Tableaux des Départements',
    ...
    'admin.sidebar.services': 'Services',
    'admin.sidebar.servicesDashboard': 'Tableau des Services',
    'admin.sidebar.allServices': 'Tous les Services',
    'admin.sidebar.foodAndDrink': 'Restauration',
    'admin.sidebar.guests': 'Invités',
    'admin.sidebar.reports': 'Rapports',
    'admin.sidebar.financeDashboard': 'Tableau Financier',
    'admin.sidebar.billing': 'Facturation',
    'admin.sidebar.invoices': 'Factures',
    'admin.sidebar.financialReports': 'Rapports Financiers',
    'admin.sidebar.transactions': 'Transactions',
    'admin.sidebar.frontOfficeDashboard': 'Tableau de Réception',
    'admin.sidebar.frontDesk': 'Réception',
    'admin.sidebar.reservations': 'Réservations',
    'admin.sidebar.inventory': 'Inventaire',
    'admin.sidebar.inventoryDashboard': 'Tableau d\'Inventaire',
    'admin.sidebar.inventoryItems': 'Articles d\'Inventaire',
  ...
  es: {
    ...
    'contact.subtitle': 'Contacte con nosotros para consultas, reservas y más.',
    ...
    // Admin sidebar
    'admin.sidebar.title': 'Panel de Admin',
    ...
    'admin.sidebar.serviceManager': 'Gerente de Servicio',
    ...
    'admin.sidebar.roomTypes': 'Tipos de Habitaciones',
    'admin.sidebar.services': 'Servicios',
    'admin.sidebar.servicesDashboard': 'Panel de Servicios',
    ...
    'admin.sidebar.financeDashboard': 'Panel de Finanzas',
    'admin.sidebar.billing': 'Facturación',
    'admin.sidebar.invoices': 'Facturas',
    'admin.sidebar.financialReports': 'Informes Financieros',
    'admin.sidebar.transactions': 'Transacciones',
    'admin.sidebar.frontOfficeDashboard': 'Panel de Recepción',
    'admin.sidebar.frontDesk': 'Recepción',
    'admin.sidebar.reservations': 'Reservas',
    'admin.sidebar.inventory': 'Inventario',
    'admin.sidebar.inventoryDashboard': 'Panel de Inventario',
    'admin.sidebar.inventoryItems': 'Artículos de Inventario',
  ...
  de: {
    ...
    // Admin sidebar
    'admin.sidebar.title': 'Admin-Panel',
    'admin.sidebar.mainDashboard': 'Hauptübersicht',
    'admin.sidebar.managerDashboards': 'Manager-Übersichten',
    'admin.sidebar.generalManager': 'Generaldirektor',
    'admin.sidebar.operationsManager': 'Betriebsleiter',
    'admin.sidebar.serviceManager': 'Serviceleiter',
    'admin.sidebar.maintenanceManager': 'Wartungsleiter',
    'admin.sidebar.marketingManager': 'Marketingleiter',
    'admin.sidebar.hrManager': 'Personalleiter',
    'admin.sidebar.departmentDashboards': 'Abteilungs-Übersichten',
    'admin.sidebar.frontOffice': 'Empfang',
    ...
    'admin.sidebar.servicesDashboard': 'Dienstleistungs-Übersicht',
    ...
    'admin.sidebar.financeDashboard': 'Finanz-Übersicht',
    'admin.sidebar.billing': 'Abrechnung',
    'admin.sidebar.invoices': 'Rechnungen',
    'admin.sidebar.financialReports': 'Finanzberichte',
    'admin.sidebar.transactions': 'Transaktionen',
    'admin.sidebar.frontOfficeDashboard': 'Empfangs-Übersicht',
    'admin.sidebar.frontDesk': 'Rezeption',
    'admin.sidebar.reservations': 'Reservierungen',
    'admin.sidebar.inventory': 'Inventar',
    'admin.sidebar.inventoryDashboard': 'Inventar-Übersicht',
    'admin.sidebar.inventoryItems': 'Inventar-Artikel',
  ...
  ar: {
    ...
    'admin.sidebar.serviceManager': 'مدير الخدمات',
    ...
    'admin.sidebar.servicesDashboard': 'لوحة الخدمات',
    ...
    'admin.sidebar.frontOfficeDashboard': 'لوحة مكتب الاستقبال',
    ...
    'admin.sidebar.inventoryItems': 'عناصر المخزون',
  ...
  pt: {
    ...
    'admin.sidebar.purchasing': 'Compras',
    'admin.sidebar.users': 'Utilizadores',
    'admin.sidebar.messages': 'Mensagens',
    'admin.sidebar.rooms': 'Quartos',
    'admin.sidebar.roomTypes': 'Tipos de Quarto',
    'admin.sidebar.services': 'Serviços',
    'admin.sidebar.servicesDashboard': 'Painel de Serviços',
  ...
  sv: {
    ...
    // Admin sidebar
    'admin.sidebar.title': 'Adminpanel',
    'admin.sidebar.mainDashboard': 'Huvudkontrollpanel',
    'admin.sidebar.managerDashboards': 'Chefkontrollpaneler',
    'admin.sidebar.generalManager': 'Verkställande direktör',
    'admin.sidebar.operationsManager': 'Driftchef',
    ...
    'admin.sidebar.departmentDashboards': 'Avdelningskontrollpaneler',
    'admin.sidebar.frontOffice': 'Reception',
    'admin.sidebar.finance': 'Finans',
    ...
    'admin.sidebar.servicesDashboard': 'Tjänstkontrollpanel',
    ...
    'admin.sidebar.financeDashboard': 'Finanskontrollpanel',
    'admin.sidebar.billing': 'Fakturering',
    'admin.sidebar.invoices': 'Fakturor',
    'admin.sidebar.financialReports': 'Finansiella rapporter',
    'admin.sidebar.transactions': 'Transaktioner',
    'admin.sidebar.frontOfficeDashboard': 'Receptionskontrollpanel',
    'admin.sidebar.frontDesk': 'Reception',
    'admin.sidebar.reservations': 'Reservationer',
    'admin.sidebar.inventory': 'Inventarier',
    'admin.sidebar.inventoryDashboard': 'Inventariekontrollpanel',
    'admin.sidebar.inventoryItems': 'Inventarieartiklar',
